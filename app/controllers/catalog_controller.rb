...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'agg_data_provider_collection_ar', field: 'agg_data_provider_collection_ssim.ar-Arab_ssim', limit: true, if: arabic_locale
    config.add_facet_field 'agg_data_provider_collection_en', field: 'agg_data_provider_collection_ssim.en_ssim', limit: true, if: en_locale
