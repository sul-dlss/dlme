...
| cho_edm_type     | `edm:type`        | R           | 0...n       | literal     | Extends the Europeana material type of the resource (TEXT, IMAGE, SOUND, VIDEO, and 3D) by adding DATASET, INTERACTIVE RESOURCE, and OBJECT | constrained list for facets, one of "Text", "Image", "Sound", "Video", "3D", "Object", "Dataset", "Interactive Resource" |
