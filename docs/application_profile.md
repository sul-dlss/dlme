...
| dlme_project               |                   |             | 1...1       | literal     | The DLME project value (currently only dlme-serials); used for filtering. | |
...
| cho_contributor  | `dc:contributor`  | R           | 0...n       | literal     | Contributor to the existence of the resource.  | |
...
| cho_creator      | `dc:creator`      | R           | 0...n       | literal     | Creator to the existence of the resource. | |
...
| cho_spatial_coordinates      |      | R           | 1...1       | literal     | Spatial coordinates of the resource. | |
...
| agg_aggregated_cho | `edm:aggregatedCHO` | M           | 1...1       | reference   | generated by the application (implied by the existence of the solr doc) | Solr document represents aggregation; inferred 1:1 relationship with the ProvidedCHO instance. derive from data if possible |
...
| wr_creator          | `dc:creator`         |             | 0...n       | literal      | Creator to the existence of the digital resource / digital asset. | |
